...
function AnalyticsPage() {
    ...
    (0, react_1.useEffect)(() => {
        async function fetchAnalytics() {
            ...
            try {
                const response = await api_1.reasoningAPI.getUserWorkflows(wallet.toString(), 100);
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-x402-border pb-6">
        ...
        <div className="flex gap-2">
          <Button_1.Button variant="secondary" size="sm" onClick={() => handleExport('csv')}>
            Export CSV
          </Button_1.Button>
          <Button_1.Button variant="secondary" size="sm" onClick={() => handleExport('json')}>
            Export JSON
          </Button_1.Button>
        </div>
      </div>
      ...
      {workflowStats ? (<>
          ...
          {spendingTrends.length > 0 && (<Card_1.Card className="p-6">
                ...
                {spendingTrends.map((trend, i) => {
                    ...
                    return (<div key={i} className="flex flex-1 flex-col items-center gap-2">
                      <div className="relative w-full">
                        <div className="w-full rounded-t bg-x402-accent" style={{
                            height: `${height}%`,
            ...
            <Card_1.Card className="p-6">
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-sm text-white">
                    {Math.min(...spendingTrends.filter((t) => t.amount > 0).map((t) => t.amount), 0).toFixed(4)}{' '}
                    SOL
                  </span>
                </div>
                <div className="flex items-center justify-between">
