...
async function main() {
    ...
    const btcEurFeed = await marketplace.createCustomFeed(customBTCEURFeed, 'custom-feed-owner');
    console.log('\nCustom Feed Created:');
    ...
    const weatherFeed = await marketplace.createCustomFeed(customWeatherFeed, 'weather-feed-owner');
    ...
    const stockFeed = await marketplace.createCustomFeed(customStockFeed, 'stock-feed-owner');
    console.log('\nStock Feed Created:');
...
//# sourceMappingURL=custom-feed-creation.js.map