...
exports.ServiceDiscoveryTool = void 0;
const base_js_1 = require("./base.js");
class ServiceDiscoveryTool extends base_js_1.BaseTool {
    discovery;
    ...
    async execute(args, context) {
        ...
        try {
            ...
            const ranked = this.discovery.rankServicesByValue(services, optimizeFor);
...
exports.ServiceDiscoveryTool = ServiceDiscoveryTool;
