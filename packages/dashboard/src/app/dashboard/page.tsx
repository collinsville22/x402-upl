...
export default function DashboardPage() {
  ...
  const [escrowBalance, setEscrowBalance] = useState({ available: 0, reserved: 0, total: 0 });
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-lg border border-[#00FF88]/20 bg-[#00FF88]/5 p-8">
        ...
        <button
          ...
          className="mt-6 rounded-lg bg-[#00FF88] px-8 py-3 font-semibold text-[#0A0A0A] transition-all hover:bg-[#00DD77]"
        >
          Create Workflow
        </button>
      </div>
