    ...
    return (<div className="flex min-h-screen items-center justify-center bg-[#0A0A0A]">
      <div className="text-center max-w-6xl px-4">
        ...
        <div className="mt-8 flex gap-4 justify-center">
          <link_1.default href="/dashboard" className="rounded-lg bg-[#00FF88] px-8 py-3 font-semibold text-[#0A0A0A] transition-all hover:bg-[#00DD77]">
            Get Started
          </link_1.default>
          <a href="https://github.com/x402-upl" target="_blank" rel="noopener noreferrer" className="rounded-lg border border-[#2A2A2A] bg-[#111111] px-8 py-3 font-semibold text-white transition-all hover:bg-[#1A1A1A]">
            Documentation
          </a>
        </div>
